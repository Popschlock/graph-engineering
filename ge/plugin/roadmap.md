...
| 0.2-polish | 0.2 polish: hook launcher python3/python; a floor column on gates; init --subject; PAUSE/STOP drawn in status.html; run_cmd timeout; pause reason newline; a second done row for a re-closed node; revise/build told about next's stderr lines; a directory-install .claudeignore | done b49fb18 | T12 | docs/superpowers/specs/2026-09-05-graph-engineering-design.md §11 plus the final review's minors (this session's ledger) | pytest | b49fb18 |
